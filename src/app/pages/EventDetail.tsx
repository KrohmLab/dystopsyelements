  ...
  if (!event) {
    return (
      <div className="min-h-screen bg-[#020202] text-white flex flex-col items-center justify-center p-4">
        <h1 className="font-orbitron text-4xl text-[#fc029b] mb-4">
          ERROR 404
        </h1>
    ...
    <div className="relative bg-[#020202] text-white min-h-screen overflow-x-hidden">
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 lg:mt-0 flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <div className="inline-block bg-[#050505]/80 border border-[#75feed]/50 px-4 py-2 mb-6 backdrop-blur-md">
              <span
                className={`font-orbitron font-bold tracking-[0.2em] uppercase ${isUpcoming ? "text-[#75feed] animate-pulse" : "text-gray-400"}`}
              >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              {isUpcoming &&
                event.ticketLink &&
                (event.ticketLink === "#" ? (
                  <div className="w-full sm:w-auto relative block cursor-not-allowed opacity-60">
                    <div className="relative px-8 py-4 bg-[#050505]/60 backdrop-blur-md border border-gray-700 overflow-hidden flex items-center justify-center">
                      <div className="relative z-10 flex items-center justify-center space-x-3 text-gray-500 font-orbitron font-bold tracking-[0.2em] uppercase text-lg">
                        <Ticket className="w-6 h-6 text-gray-500" />
                        <span>Billetterie indisponible</span>
                      </div>
                    </div>
                  </div>
                ) : (
                  <a
                    ...
                    className="w-full sm:w-auto relative group/btn block"
                  >
              ...
              {event.facebookLink && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto relative group/info block"
                >
                  <div className="relative px-8 py-4 bg-transparent overflow-hidden flex items-center justify-center">
                    ...
                    <div className="relative z-10 flex items-center justify-center space-x-3 text-gray-400 font-orbitron font-bold tracking-[0.2em] uppercase text-sm">
                      ...
                      <span className="group-hover/info:text-glow-pink group-hover/info:text-white transition-all">
                        Événement FB
                      </span>
                    </div>
                  </div>
      ...
      <section className="py-12 relative z-10 bg-[#020202]">
        <FloatingPattern
          variant={2}
          color="pink"
          className="w-[400px] h-[400px] right-0 top-[10%] opacity-5"
          delay={1}
        />
              ...
              {event.artists.map((artist, idx) => (
                ...
                >
                  <div className="relative aspect-[3/4] mb-4 w-full shrink-0">
                    <div
                      className={`absolute -inset-2 border border-gray-800/50 ${artist.type === "Live" ? "group-hover:border-[#fc029b]/40" : "group-hover:border-[#75feed]/40"} bg-transparent transition-colors duration-500`}
                    />
                    <div
                      className={`absolute -top-2 -left-2 w-3 h-3 border-t-2 border-l-2 ${artist.type === "Live" ? "border-[#fc029b]" : "border-[#75feed]"} group-hover:w-6 group-hover:h-6 transition-all duration-500 z-20`}
                    />
                    <div
                      className={`absolute -bottom-2 -right-2 w-3 h-3 border-b-2 border-r-2 ${artist.type === "Live" ? "border-[#fc029b]" : "border-[#75feed]"} group-hover:w-6 group-hover:h-6 transition-all duration-500 z-20`}
                    />
                    ...
                    <div className="relative z-10 w-full h-full overflow-hidden bg-[#080808] border border-gray-900 group-hover:border-gray-800 transition-colors">
                      ...
                      <div className="absolute top-0 left-0 z-30 bg-[#050505]/90 backdrop-blur-sm px-3 py-1 border-b border-r border-gray-800">
                        <span
                          className={`font-orbitron text-[10px] font-bold uppercase tracking-widest ${artist.type === "Live" ? "text-[#fc029b]" : "text-[#75feed]"}`}
                        >
                          {artist.type}
                        </span>
                      </div>
              ...
              <div className="w-full md:w-3/5 p-6 sm:p-8 md:p-12 relative flex flex-col overflow-y-auto">
                ...
                <div className="mb-6 relative z-10">
                  <div className="flex items-center space-x-4 mb-4">
                    <span
                      className={`font-orbitron text-xs font-bold uppercase tracking-widest px-3 py-1 bg-[#050505] border border-gray-800 ${selectedArtist.type === "Live" ? "text-[#fc029b] border-[#fc029b]/30" : "text-[#75feed] border-[#75feed]/30"}`}
                    >
                      {selectedArtist.type}
                    </span>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-auto relative z-10 shrink-0">
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center space-x-3">
                      ...
                      <span className="font-orbitron text-sm font-bold uppercase tracking-widest text-gray-300 group-hover/sc:text-glow-cyan group-hover/sc:text-white transition-all">
                        SoundCloud
                      </span>
                    </div>
                  </a>
