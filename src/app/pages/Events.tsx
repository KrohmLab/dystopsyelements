        ...
        <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mt-16 w-full">
          ...
          >
            ...
            <p className="font-rajdhani text-xl text-gray-300 max-w-2xl mx-auto box-glow-cyan-text">
              Accédez à toutes nos expériences immersives. Du
              prochain Nexen Festival aux soirées underground
              passées.
            </p>
          </motion.div>
        </div>
            ...
            >
              ...
              >
                ...
                {activeTab === "past" && (
                  <motion.div
                    layoutId="activeTab"
                    className="absolute inset-0 border border-[#fc029b] bg-[#fc029b]/10 z-[-1]"
                    style={{
                      clipPath:
                        "polygon(10px 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%, 0 10px)",
                    }}
            ...
            {displayedEvents.map((event, index) => (
              ...
              >
                ...
                >
                  ...
                  />
                  <div
                    className="absolute -inset-1.5 border border-gray-800/50 bg-transparent group-hover:border-gray-500/40 transition-colors duration-500 delay-75"
                    style={{
                      clipPath:
                  ...
                  />
                  <div
                    className={`absolute -top-3 -left-3 w-3 h-3 border-t-2 border-l-2 ${activeTab === "upcoming" ? "border-[#75feed]" : "border-gray-500"} group-hover:w-6 group-hover:h-6 transition-all duration-500 z-20`}
                  />
                  <div
                    className={`absolute -bottom-3 -right-3 w-3 h-3 border-b-2 border-r-2 ${activeTab === "upcoming" ? "border-[#fc029b]" : "border-gray-500"} group-hover:w-6 group-hover:h-6 transition-all duration-500 z-20`}
                  />
                  <div
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-b from-transparent ${activeTab === "upcoming" ? "via-[#75feed]/10" : "via-[#fc029b]/10"} to-transparent translate-y-[-100%] group-hover:animate-[scan_2.5s_ease-in-out_infinite] z-20 pointer-events-none`}
                    />
                    <img
                      src={event.image}
                      alt={event.title}
                      className="absolute inset-0 w-full h-full object-cover opacity-0 group-hover:opacity-50 mix-blend-screen -translate-x-1 translate-y-0.5 filter hue-rotate-90 group-hover:animate-[glitch-anim-1_0.2s_infinite] transition-all duration-300 z-10"
                    />
                    <img
                      src={event.image}
                      alt={event.title}
                      className="absolute inset-0 w-full h-full object-cover opacity-0 group-hover:opacity-50 mix-blend-screen translate-x-1 -translate-y-0.5 filter hue-rotate-[270deg] group-hover:animate-[glitch-anim-2_0.3s_infinite] transition-all duration-300 z-10"
                    />
                    <img
                      src={event.image}
                      alt={event.title}
                      className={`relative z-0 w-full h-full object-cover ${activeTab === "past" ? "grayscale opacity-70 group-hover:opacity-100" : "opacity-90 group-hover:opacity-100"} mix-blend-lighten group-hover:scale-105 transition-all duration-700`}
                    />
                    <div
                      className="absolute top-0 left-0 z-30 bg-[#050505]/90 backdrop-blur-sm px-4 py-2 border-b border-r border-gray-800"
                      style={{
                        clipPath:
                    ...
                    >
                      <span
                        className={`font-rajdhani text-sm font-bold uppercase tracking-widest ${activeTab === "upcoming" ? "text-[#75feed]" : "text-gray-400"}`}
                      >
                        {new Date(
                          event.date,
                ...
                <div className="flex flex-col flex-grow px-2">
                  ...
                  <div className="space-y-2 mb-6 font-rajdhani text-gray-400">
                    <div className="flex items-center space-x-2">
                      <Clock className="w-4 h-4 text-[#fc029b]" />
                      <span>{event.time}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <MapPin className="w-4 h-4 text-[#75feed]" />
                  ...
                  <div className="pt-4 flex flex-col space-y-3">
                        ...
                        >
                          <div className="relative px-4 py-3 bg-[#050505]/60 backdrop-blur-md border border-[#75feed] overflow-hidden flex items-center justify-center">
                            ...
                            <div className="relative z-10 flex items-center space-x-2 text-white font-orbitron font-bold tracking-[0.1em] uppercase text-sm">
                              ...
                              <span className="group-hover/btn:text-glow-cyan transition-all">
                                Billetterie
                              </span>
                            </div>
                          </div>
                    ...
                    <Link
                      to={`/events/${event.id}`}
                      className="group/info block w-full"
                    >
                      <div
                        className={`relative px-4 py-3 bg-[#050505]/60 backdrop-blur-md border ${activeTab === "upcoming" ? "border-[#75feed]" : "border-[#fc029b]"} overflow-hidden flex items-center justify-center`}
                      >
                        <span
                          className={`absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent ${activeTab === "upcoming" ? "via-[#75feed]" : "via-[#fc029b]"} to-transparent -translate-x-full group-hover/info:translate-x-full transition-transform duration-1000 ease-in-out`}
                        />
                        <span
                          className={`absolute bottom-0 right-0 w-full h-[2px] bg-gradient-to-l from-transparent ${activeTab === "upcoming" ? "via-[#75feed]" : "via-[#fc029b]"} to-transparent translate-x-full group-hover/info:-translate-x-full transition-transform duration-1000 ease-in-out`}
                        />
                        <span
                          className={`absolute inset-0 ${activeTab === "upcoming" ? "bg-[#75feed]/10" : "bg-[#fc029b]/10"} translate-y-[100%] group-hover/info:translate-y-0 transition-transform duration-300 ease-in-out`}
                        />
                        <div className="relative z-10 flex items-center space-x-2 text-white font-orbitron font-bold tracking-[0.1em] uppercase text-sm">
                          <span
                            className={`transition-all ${activeTab === "upcoming" ? "group-hover/info:text-glow-cyan" : "group-hover/info:text-glow-pink"}`}
                          >
                            Plus d'infos
                          </span>
                          <ArrowRight
                            className={`w-4 h-4 ${activeTab === "upcoming" ? "text-[#75feed]" : "text-[#fc029b]"} group-hover/info:translate-x-1 transition-transform`}
                          />
                        </div>
                      </div>
                    </Link>
          ...
          {displayedEvents.length === 0 && (
            <div className="text-center py-20">
              <p className="font-orbitron text-xl text-gray-500 uppercase tracking-widest">
                Aucun événement dans cette catégorie pour le
                moment.
              </p>
            </div>
          )}
