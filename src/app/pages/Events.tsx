    ...
    <div className="relative bg-[#020202] text-white min-h-screen overflow-x-hidden">
      ...
      <section className="relative w-full h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            <h1 className="font-orbitron text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#75feed] to-[#fc029b] uppercase tracking-widest mb-4">
              Billetterie
            </h1>
